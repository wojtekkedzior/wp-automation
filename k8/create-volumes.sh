...
function staticVolumes() {
    ...
    #worker 3 & 4
        ...
        qemu-img create "${path}/worker3-4.qcow2" ${verySmallVolSz} -f qcow2 -o preallocation=full
        qemu-img create "${path}/worker3-5.qcow2" ${verySmallVolSz} -f qcow2 -o preallocation=full
        qemu-img create "${path}/worker3-6.qcow2" ${verySmallVolSz} -f qcow2 -o preallocation=full
        ...
        qemu-img create "${path}/worker4-4.qcow2" ${verySmallVolSz} -f qcow2 -o preallocation=full
        qemu-img create "${path}/worker4-5.qcow2" ${verySmallVolSz} -f qcow2 -o preallocation=full
        qemu-img create "${path}/worker4-6.qcow2" ${verySmallVolSz} -f qcow2 -o preallocation=full
}